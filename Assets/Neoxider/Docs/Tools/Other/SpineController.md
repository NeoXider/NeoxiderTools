...
**Что это:** Компонент является центральной точкой для управления Spine-анимациями на объекте. Он требует наличия `SkeletonAnimation` и автоматически получает ссылки на него.
