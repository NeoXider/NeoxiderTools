...
- `CountActive` (`int`): Количество элементов, считающихся активными: в режиме «один выбран» — 0 или 1; в режиме fill — effectiveIndex + 1. Используйте для условий победы/поражения (например, NeoCondition: `CountActive >= 4` → поражение).
