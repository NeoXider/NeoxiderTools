...
**Что это:** Файл `Enums.cs` содержит определения различных перечислений (`enum`), которые используются в качестве параметров в других методах-расширениях для управления их поведением.
