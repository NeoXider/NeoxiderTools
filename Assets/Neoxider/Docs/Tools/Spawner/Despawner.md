...
**Что это:** Компонент для «удаления» игрового объекта: возврат в пул (если объект из пула) или `Destroy`. Можно вызывать по выключению, из кода или кнопкой в Inspector.
