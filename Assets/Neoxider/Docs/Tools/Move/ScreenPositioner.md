...
**Что это:** Этот компонент полезен для размещения объектов, которые должны сохранять свое положение относительно вида камеры, например, для элементов интерфейса, которые находятся в мировом пространстве, а не ...
