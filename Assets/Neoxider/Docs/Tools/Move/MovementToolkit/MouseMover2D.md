...
**Что это:** Как и `KeyboardMover`, он автоматически определяет наличие `Rigidbody2D` на объекте для выбора между физическим и нефизическим способом перемещения.
