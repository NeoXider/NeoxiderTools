...
**Что это:** Атрибут `[FindAllInScene]` автоматизирует поиск **всех** компонентов указанного типа на текущей активной сцене и автоматически назначает их в поле типа массив или `List`.
