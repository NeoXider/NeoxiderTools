...
namespace Neo.Editor
{
    ...
    public static class ResourceDrawer
    {
        ...
        private static void ProcessNullField(System.Reflection.FieldInfo field, MonoBehaviour targetObject)
        {
        ...
        private static void ProcessEmptyCollection(System.Reflection.FieldInfo field, MonoBehaviour targetObject)
        {
            if (HasAttribute<LoadAllFromResourcesAttribute>(field))
                AssignAllResources(field, targetObject);
        }

        private static void AssignResource(System.Reflection.FieldInfo field, MonoBehaviour targetObject)
        {
        ...
        private static void AssignAllResources(System.Reflection.FieldInfo field, MonoBehaviour targetObject)
        {
        ...
        private static void SetFieldValueForCollection(System.Reflection.FieldInfo field, MonoBehaviour targetObject, Array value)
        {
            ...
            {
                Debug.LogWarning($"Field '{field.Name}' is neither an array nor an IList, and no resources were found.");
            }
        }

        private static bool HasAttribute<T>(System.Reflection.FieldInfo field) where T : Attribute
        {
