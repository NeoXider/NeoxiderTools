...
**Что это:** Компонент взрывной силы, который применяет взрывную силу ко всем объектам в заданном радиусе. Идеально подходит для создания взрывных бочек, гранат, взрывов при спавне и других эффектов.
