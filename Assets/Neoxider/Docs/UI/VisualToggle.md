...
**Как использовать:** добавить на объект с визуалом; задать элементы в списках start/end; переключать через свойство IsActive или методы SetOn/SetOff. При наличии Toggle на том же объекте — автосинхронизация. См. секции ниже.
...
5. **События**: UnityEvent для интеграции с другими системами
