...
**Что это:** компонент доски для общих карт: фиксированные слоты (Card Slots), режимы Table/Beat, управление картами на столе. Используется для флопа/тёрна/ривера, бита в «Дурак» и любых зон со слотами. Файл в `Scripts/Cards/Components/`.

**Как использовать:** добавить на объект стола; задать **Card Slots** (массив Transform) или включить **Auto Generate Slots**; при необходимости назначить DeckComponent. См. «Настройки в инспекторе» ниже.
