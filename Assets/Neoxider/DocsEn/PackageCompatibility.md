...
| Source | Version |
|--------|---------|
| `Assets/Neoxider/package.json` | `version: 9.2.2`, `unity: 2022.1` |
...
- For `9.2.2`, the package version changed but the minimum Unity version stayed unchanged; `com.unity.ugui` is now declared for imported uGUI samples.
