...
**Что это:** `CheckSpin` — это сериализуемый класс-помощник, который инкапсулирует логику проверки результатов спина в слоте. Он определяет выигрышные линии, рассчитывает соответствующие им множители, а также п...
