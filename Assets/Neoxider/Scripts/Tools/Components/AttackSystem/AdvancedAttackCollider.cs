...
namespace Neo.Tools
{
    ...
    public class AdvancedAttackCollider : MonoBehaviour
    {
        ...
        private void HandleAttack(GameObject target, Vector3 contactPosition, Vector3 contactNormal,
            bool hasContactNormal)
        {
            ...
            if (applyForceOnHit)
            {
                Vector3 direction = hasContactNormal
                    ? contactNormal
