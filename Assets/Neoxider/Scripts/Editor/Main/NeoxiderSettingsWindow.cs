    ...
    public class NeoxiderSettingsWindow : EditorWindow
    {
        ...
        private void DrawFolderSettings()
        {
            ...
            if (showFolderSettings)
            {
                ...
                {
                    EditorGUILayout.BeginHorizontal();
                    NeoxiderSettings.Current.folders[i] = EditorGUILayout.TextField(NeoxiderSettings.Current.folders[i]);
                    
                    if (GUILayout.Button("×", GUILayout.Width(20)))
                    {
                        NeoxiderSettings.Current.folders = NeoxiderSettings.Current.folders.Where((_, index) => index != i).ToArray();
                        break;
                    }
                    EditorGUILayout.EndHorizontal();
                }
        ...
        private void DrawActionButtons()
        {
            ...
            if (GUILayout.Button("Validate Folder Structure"))
            {
                ValidateFolders();
            }
