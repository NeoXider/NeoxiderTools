...
**Что это:** утилиты редактора Unity (не в билд): поиск/удаление missing-скриптов, бэкапы, массовое изменение текстур, создание иерархии сцены, расширения инспектора. Скрипты в `Scripts/Editor/` и подпапках.
