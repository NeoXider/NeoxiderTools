...
**Что это:** Магнитное поле, которое притягивает или отталкивает объекты в радиусе. Идеально подходит для создания магнитных эффектов, сбора предметов, защитных полей и других интерактивных элементов.
