...
**Что это:** Это избавляет от необходимости вручную вводить значения от 0 до 1 в полях `Anchor Min` и `Anchor Max` и сразу же сбрасывает позицию объекта в ноль, что упрощает выравнивание UI-элементов.
