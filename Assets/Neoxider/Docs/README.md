...
Канонический вход в русскую документацию **NeoxiderTools** `v9.2.3`. Это карта переиспользования: перед новой реализацией проверьте, нет ли уже готового runtime API, MonoBehaviour-обертки или sample-сцены.
