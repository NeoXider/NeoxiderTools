...
**Что это:** Он работает в связке с `MouseInputManager`, реагируя на события нажатия, удержания и отпускания кнопки мыши, что делает интерфейс более живым и отзывчивым. Подписки выполняются в `OnEnable`, отписк...
