...
**Как использовать:** добавить на объект, задать startVector/endVector, animationType, animationSpeed; вызывать Play/Pause/Stop из кода или UnityEvent; подписаться на событие изменения вектора при необходимости.
