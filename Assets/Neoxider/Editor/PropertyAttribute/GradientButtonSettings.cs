...
namespace Neo.Editor
{
    ...
    public static class GradientButtonSettings
    {
        ...
        private static readonly Color Scheme1_Top = new Color(0.2f, 0.8f, 1f, 1f);      // Яркий cyan
        private static readonly Color Scheme1_Bottom = new Color(0.6f, 0.2f, 1f, 1f);   // Фиолетовый
        
        // Схема 2: Глубокий элегантный (Dark Blue -> Purple)
        private static readonly Color Scheme2_Top = new Color(0.3f, 0.4f, 0.9f, 1f);    // Синий
        private static readonly Color Scheme2_Bottom = new Color(0.7f, 0.3f, 0.9f, 1f); // Фиолетовый
        
        // Схема 3: Discord стиль (Blurple gradient)
        private static readonly Color Scheme3_Top = new Color(0.35f, 0.4f, 0.95f, 1f);  // Blurple светлый
        private static readonly Color Scheme3_Bottom = new Color(0.45f, 0.3f, 0.85f, 1f); // Blurple темный
        
        // Схема 4: Тёплый закат (Orange -> Pink)
        private static readonly Color Scheme4_Top = new Color(1f, 0.45f, 0.3f, 1f);     // Оранжевый
        private static readonly Color Scheme4_Bottom = new Color(0.95f, 0.3f, 0.6f, 1f); // Розовый
        
        // Схема 5: Зелёный Matrix (Green gradient)
        private static readonly Color Scheme5_Top = new Color(0.3f, 0.95f, 0.5f, 1f);   // Светло-зелёный
        private static readonly Color Scheme5_Bottom = new Color(0.2f, 0.7f, 0.4f, 1f); // Тёмно-зелёный
        
        // Схема 6: Тёмный киберпанк (Dark Cyber) ⭐ НОВАЯ
        private static readonly Color Scheme6_Top = new Color(0.15f, 0.15f, 0.25f, 1f);    // Тёмно-синий
        private static readonly Color Scheme6_Bottom = new Color(0.25f, 0.1f, 0.35f, 1f);  // Тёмно-фиолетовый
        private static readonly Color Scheme6_Accent = new Color(0.4f, 0.9f, 1f, 1f);      // Неоновый cyan акцент
        
        // === АКТИВНАЯ СХЕМА (измените номер для выбора) ===
        private static int ActiveScheme = 6; // 1-6
        ...
        public static Color InspectorBackgroundColor => new Color(0.22f, 0.22f, 0.22f, 1f);
    }
}
