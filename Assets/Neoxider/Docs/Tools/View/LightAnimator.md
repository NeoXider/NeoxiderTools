...
**Что это:** Компонент для анимации источников света (Light и Light2D). Поддерживает различные типы анимации интенсивности и цвета. Автоматически определяет тип источника света и применяет анимацию соответствую...
