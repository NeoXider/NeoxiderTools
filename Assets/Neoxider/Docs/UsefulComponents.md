...
| **Components** | RpgStatsDamageableBridge, Counter, Loot, TextScore, TypewriterEffectComponent; *Health, Evade, AttackExecution, AdvancedAttackCollider — legacy, см. [RPG](./Rpg/README.md) (`RpgStatsManager`, `RpgCombatant`, `RpgAttackController`, `RpgEvadeController`)* |
