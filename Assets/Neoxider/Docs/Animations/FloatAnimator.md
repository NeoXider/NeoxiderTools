...
**Как использовать:** добавить на объект, задать start/end, animationType, animationSpeed; вызывать Play/Pause/Stop; подписаться на событие изменения значения при необходимости.
