...
**Что это:** `SpeedControll` — это простая сериализуемая структура, предназначенная для хранения параметров, управляющих скоростью и временем вращения барабана (`Row`).
