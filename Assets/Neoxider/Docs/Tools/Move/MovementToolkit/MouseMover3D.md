...
**Что это:** Это делает его подходящим для самых разных жанров, от RTS и RPG с "point-and-click" управлением до аркад, где объект следует за курсором в определенной плоскости.
