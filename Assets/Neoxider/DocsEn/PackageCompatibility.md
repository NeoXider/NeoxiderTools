...
| Source | Version |
|--------|---------|
| `Assets/Neoxider/package.json` | `version: 9.2.0`, `unity: 2022.1` |
...
- For `9.2.0`, the package version changed but the minimum Unity version and package dependency floor stayed unchanged.
