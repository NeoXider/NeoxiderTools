...
**Что это:** компонент бесшовного параллакс-фона для 2D: тайлы раскладываются вокруг камеры, двигаются с заданным множителем, переиспользуются при выходе из видимости. Поддержка автоскролла, вариантов спрайтов, предпросмотра в редакторе. Файл: `Scripts/Parallax/ParallaxLayer.cs`.

**Как использовать:** добавить на объект со SpriteRenderer (шаблон тайла), при необходимости назначить targetCamera, настроить parallaxMultiplier и scrollSpeed, включить generateInEditor для предпросмотра.
