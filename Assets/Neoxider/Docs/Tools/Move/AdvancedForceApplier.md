...
**Что это:** Универсальный компонент для приложения физических сил к 2D и 3D объектам с расширенными возможностями настройки направления, ограничений скорости и случайных параметров.
