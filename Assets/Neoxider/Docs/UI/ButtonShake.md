...
**Что это:** Компонент гибко настраивается: можно задать силу и продолжительность тряски, а также указать, когда она должна происходить — постоянно, при нажатии или после него.
