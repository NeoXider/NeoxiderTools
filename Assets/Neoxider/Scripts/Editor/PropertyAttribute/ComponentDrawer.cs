    ...
    public static class ComponentDrawer
    {
        ...
        public static void ProcessComponentAttributes(MonoBehaviour targetObject)
        {
            ...
            foreach (var field in fields)
            {
                ...
                bool isNull = fieldValue == null || (fieldValue is UnityEngine.Object obj && obj == null);
        ...
        private static UnityEngine.Object[] GetComponentsFromScene(Type componentType, FindObjectsSortMode sortMode = FindObjectsSortMode.None)
        {
