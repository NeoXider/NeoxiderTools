...
**Что это:** `UpdateChilds` — это удобная утилита, предназначенная для быстрого управления дочерними объектами. Если у вас есть объект, который постоянно создает временные дочерние элементы (например, эффекты, ...
