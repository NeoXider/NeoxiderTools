...
**Что это:** Компонент использует DOTween для создания плавного эффекта тряски. Поддерживает тряску позиции, поворота или обоих одновременно. После завершения автоматически возвращает объект в исходное состояние.
