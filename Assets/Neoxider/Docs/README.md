...
| **Level** | Менеджер уровней, загрузка сцен (SceneFlowController), карта, кнопки | [`Level/LevelManager.md`](./Level/LevelManager.md), [`Level/LevelButton.md`](./Level/LevelButton.md), [`Level/SceneFlowController.md`](./Level/SceneFlowController.md) |
| **NPC** | Модульная навигация NPC (патруль, преследование, агро) | [`NPC/README.md`](./NPC/README.md) |
| **Parallax** | Параллакс-слои с предпросмотром | [`Parallax/ParallaxLayer.md`](./Parallax/ParallaxLayer.md) |
