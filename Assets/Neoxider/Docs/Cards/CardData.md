...
**Что это:** неизменяемая структура данных одной карты (readonly struct): Suit, Rank, IsJoker, IsRedJoker. Поддержка сравнения и проверки на козырь. Пространство имён/файл в модуле Cards.

**Как использовать:** создавать через конструктор или из DeckConfig; передавать в ICardView.SetData(CardData, faceUp). См. «Свойства» и «Создание» ниже.
