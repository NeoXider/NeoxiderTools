...
**Публичные методы**
- `UpdatePlayerScore(int score)`: **Основной метод для использования в игре.** Обновляет очки игрока, автоматически сохраняет данные, пересортировывает всю таблицу и обновляет UI.
