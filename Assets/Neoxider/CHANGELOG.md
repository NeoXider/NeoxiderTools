...
- Sample: **Character Movement Fundamentals** (`Samples~/CharacterMovementFundamentals/`, importable from Package Manager) — upstream demo scenes, controller prefabs (blank/simplified/animated), the Capguy character with its animator, environment art and sounds.
